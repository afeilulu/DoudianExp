...
public class GetProgramRelatedIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetProgramRelatedIoHandler.class);

	public GetProgramRelatedIoHandler(Intent intent){
		mIntent = intent;
