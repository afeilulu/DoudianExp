...
public class GetTotalInAreaIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetTotalInAreaIoHandler.class);

	public GetTotalInAreaIoHandler(Intent intent){
		mIntent = intent;
