...
public class GetCategoriesIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetCategoriesIoHandler.class);

	public GetCategoriesIoHandler(Intent intent){
		mIntent = intent;
