...
public class GetProgramInAreaCategoryByPageIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetProgramInAreaCategoryByPageIoHandler.class);

	public GetProgramInAreaCategoryByPageIoHandler(Intent intent){
		mIntent = intent;
