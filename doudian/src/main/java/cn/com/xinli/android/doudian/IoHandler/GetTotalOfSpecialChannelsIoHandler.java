...
public class GetTotalOfSpecialChannelsIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetTotalOfSpecialChannelsIoHandler.class);

	public GetTotalOfSpecialChannelsIoHandler(Intent intent){
		mIntent = intent;
