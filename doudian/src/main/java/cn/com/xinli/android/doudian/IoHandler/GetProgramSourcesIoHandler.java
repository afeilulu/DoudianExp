...
public class GetProgramSourcesIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetProgramSourcesIoHandler.class);

	public GetProgramSourcesIoHandler(Intent intent){
		mIntent = intent;
