...
public class GetNormalChannelsByPageIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetNormalChannelsByPageIoHandler.class);

	public GetNormalChannelsByPageIoHandler(Intent intent){
		mIntent = intent;
