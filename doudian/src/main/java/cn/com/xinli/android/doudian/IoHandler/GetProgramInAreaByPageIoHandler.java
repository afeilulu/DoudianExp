...
public class GetProgramInAreaByPageIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetProgramInAreaByPageIoHandler.class);

	public GetProgramInAreaByPageIoHandler(Intent intent){
		mIntent = intent;
