...
public class GetProgramByPageIoHandler extends AbstractIoHandler {
	
	private final static Logger LOGGER = LoggerFactory.getLogger(GetProgramByPageIoHandler.class);
	
	public GetProgramByPageIoHandler(Intent intent){
		mIntent = intent;
