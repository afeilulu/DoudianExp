...
public class GetChannelsIoHandler extends AbstractIoHandler {
	
	private final static Logger LOGGER = LoggerFactory.getLogger(GetChannelsIoHandler.class);
	
	public GetChannelsIoHandler(Intent intent){
		mIntent = intent;
