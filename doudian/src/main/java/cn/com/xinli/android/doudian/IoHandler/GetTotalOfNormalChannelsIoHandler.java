...
public class GetTotalOfNormalChannelsIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetTotalOfNormalChannelsIoHandler.class);

	public GetTotalOfNormalChannelsIoHandler(Intent intent){
		mIntent = intent;
