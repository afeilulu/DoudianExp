...
public class GetTotalInCategoryIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetTotalInCategoryIoHandler.class);

	public GetTotalInCategoryIoHandler(Intent intent){
		mIntent = intent;
