...
public class GetTotalInAreaCategoryIoHandler extends AbstractIoHandler {

	private final static Logger LOGGER = LoggerFactory.getLogger(GetTotalInAreaCategoryIoHandler.class);

	public GetTotalInAreaCategoryIoHandler(Intent intent){
		mIntent = intent;
