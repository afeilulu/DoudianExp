...
public class BitmapUtilsTask extends AsyncTask<Object, Void, Bitmap> {
    ...
    private static final String TAG = "BitmapUtilsTask";
     ...
     */
    public Bitmap getBitmap(final String string, Object fileObj, int optSize) throws MalformedURLException, IOException {
        File file = (File)fileObj;        
        // Get the source image's dimensions
//        int desiredWidth = 1000;
        int desiredWidth = optSize;
    ...
    protected Bitmap doInBackground(Object... item) {
        ...
        try {
            if (item[1].toString().equals("thumb"))
                ...
                return getBitmap(item[0].toString(), item[2], (Integer) item[3]);
        } catch (MalformedURLException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
