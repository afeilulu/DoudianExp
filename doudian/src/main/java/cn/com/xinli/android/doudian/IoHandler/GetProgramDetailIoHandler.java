...
public class GetProgramDetailIoHandler extends AbstractIoHandler {
	
	private final static Logger LOGGER = LoggerFactory.getLogger(GetProgramDetailIoHandler.class);
	
	public GetProgramDetailIoHandler(Intent intent){
		mIntent = intent;
